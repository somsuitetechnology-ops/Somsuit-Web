...
export default function AdminDashboard() {
  ...
  const createMutation = useMutation({
    ...
    onError: (err) => {
      toast({
        title: "Error",
        description: err instanceof ApiError ? err.message : "Failed to create client",
        variant: "destructive",
      });
    },
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: (err) => {
      toast({
        title: "Error",
        description: err instanceof ApiError ? err.message : "Failed to update client",
        variant: "destructive",
      });
    },
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: (err) => {
      toast({
        title: "Error",
        description: err instanceof ApiError ? err.message : "Failed to delete client",
        variant: "destructive",
      });
    },
  });
